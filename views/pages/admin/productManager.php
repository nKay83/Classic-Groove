      ...
      <div class="modal-left ">
        <div class="modal-info">
          ...
          <div class="modal-item">
            ...
            <div class="item-input"><input type="text" class="albumName" disabled></div>
          </div>
          <div class="modal-item">
          ...
          <div class="modal-item">
            ...
            <div class="item-input"><input type="text" class="albumArtist" disabled></div>
          </div>
          <div class="modal-item">
            <div class="item-header">Quanitity</div>
            <div class="item-input"><input type="text" class="albumQuanitity" disabled></div>
          </div>
          <div class="modal-item">
            <div class="item-header">Price</div>
            <div class="item-input"><input type="text" class="albumPrice" disabled></div>
          </div>

          <div class="modal-item">
            <div class="item-header">Image</div>
            <div class="item-input"><input type="text" class="albumImg" disabled></div>
          </div>
          <div class="modal-item">
            <div class="item-header">Describe</div>
            <div class="item-input"><textarea cols="30" class="albumDescribe" rows="6" disabled></textarea></div>
          </div>
        </div>
      </div>
